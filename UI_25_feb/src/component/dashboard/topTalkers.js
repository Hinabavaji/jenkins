...
const TopTalkers = () => {
    ...
    const [TalkersDetails, setTalkersDetails] = useState([
        {
            id: 1,
            event_name: 'Asset 1',
            ip: '192.168.1.1',
    ...
    const filteredTalkersDetails = TalkersDetails.filter((event) =>
        ...
        event.duration?.toLowerCase().includes(eventsearchQuery.toLowerCase()) ||
        ...
        <Col xs={12} md={8} lg={6} className="mx-auto">
            ...
            >
                ...
                <Row className="align-items-center mb-3">
                    <Col xs={12} md={6}>
                        <h5 className="fw m-0">Top 10 assets Talkers(Uploads)</h5>
                    </Col>
                ...
                <div className="table-container" style={{
                    ...
                    {Array.isArray(filteredTalkersDetails) && filteredTalkersDetails.length > 0 ? (
                        filteredTalkersDetails.map((events, index) => (
                            <Row
                                key={index}
                            ...
                            >
                                <Col xs={12} sm={4} md={2} className="py-1 text-truncate">{events.event_name} </Col>
                        ...
                        <p className="text-center mt-2 text-muted">No talkers found.</p>
                    )}
                </div>
            </div>
        </Col>
